...
import com.syos.repository.interfaces.PhysicalStoreInventoryRepository.ProductStockSummary;
...
/**
 * Unit tests for PhysicalStoreInventoryRepositoryImpl.
 */
@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
class PhysicalStoreInventoryRepositoryImplTest {
    ...
    private PhysicalStoreInventoryRepositoryImpl repository;
    ...
    class SaveTests {
        ...
        void shouldInsertNewInventory() throws Exception {
            ...
            inventory.setQuantityOnShelf(10);
            ...
            PhysicalStoreInventory saved = repository.save(inventory);

            assertEquals(1, saved.getPhysicalInventoryId());
        }
    }
    ...
    class FindByIdTests {
        ...
        void shouldFindInventoryById() throws Exception {
            ...
            Optional<PhysicalStoreInventory> result = repository.findById(1);

            assertTrue(result.isPresent());
            assertEquals(10, result.get().getQuantityOnShelf());
        }
    }
    ...
    class FindByProductCodeTests {
        ...
        void shouldFindInventoryByProductCode() throws Exception {
            ...
            List<PhysicalStoreInventory> result = repository.findByProductCode("P001");
    ...
    class FindAvailableByProductCodeTests {
        ...
        void shouldFindAvailableInventory() throws Exception {
            ...
            List<PhysicalStoreInventory> result = repository.findAvailableByProductCode("P001");
    ...
    @Nested
    @DisplayName("getTotalQuantityOnShelf tests")
    class GetTotalQuantityOnShelfTests {

        @Test
        @DisplayName("Should get total quantity on shelf")
        void shouldGetTotalQuantityOnShelf() throws Exception {
            when(resultSet.next()).thenReturn(true);
            when(resultSet.getInt(1)).thenReturn(50);

            int total = repository.getTotalQuantityOnShelf("P001");
    ...
    class FindLowStockTests {
        ...
        void shouldFindLowStockItems() throws Exception {
            ...
            List<PhysicalStoreInventory> result = repository.findLowStock(10);

            assertEquals(1, result.size());
            assertEquals(5, result.get(0).getQuantityOnShelf());
        }
    }
    ...
    class FindAllTests {
        ...
        void shouldFindAllInventory() throws Exception {
            ...
            List<PhysicalStoreInventory> result = repository.findAll();
