        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="${pageContext.request.contextPath}/orders" class="text-gray-600 hover:text-syos-primary">
                        My Orders
                    </a>
                </div>
            </div>
        ...
        function renderCart() {
            ...
            container.innerHTML = cart.items.map(item => `
                <div class="p-6 flex items-center space-x-4" data-product="\${item.productCode}">
                    <div class="h-20 w-20 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            try {
                ...
                if (data.data && !data.data.isValid) {
                    ...
                    issuesDiv.innerHTML = issues.map(issue =>
                        `<p>• \${issue.productName}: Only \${issue.availableQuantity} available (requested \${issue.requestedQuantity})</p>`
                    ).join('');
