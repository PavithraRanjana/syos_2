                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <div class="stat-card border-syos-primary">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                Rs.
                                <fmt:formatNumber value="${summary.todaySales()}" pattern="#,##0.00" />
                            </p>
                        ...
                        <div class="stat-card border-syos-success">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                Rs.
                                <fmt:formatNumber value="${summary.weekSales()}" pattern="#,##0.00" />
                            </p>
                        </div>
                        <div class="stat-card border-syos-secondary">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                Rs.
                                <fmt:formatNumber value="${summary.monthSales()}" pattern="#,##0.00" />
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="card">
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="${pageContext.request.contextPath}/reports/bills"
                                    ...
                                    <div class="ml-4">
                                        <p class="font-medium text-gray-900">Daily Bill Report</p>
                                        <p class="text-sm text-gray-500">View detailed transactions and line items
                                        </p>
                                    </div>
                                </a>
                        ...
                        <div class="card">
                            ...
                            <div class="space-y-3">
                                <a href="${pageContext.request.contextPath}/reports/reshelve"
                                ...
                                <a href="${pageContext.request.contextPath}/reports/reorder-level"
                                ...
                                <a href="${pageContext.request.contextPath}/reports/batch-stock"
                                ...
                                <div class="table-container">
                                    <table class="data-table">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <c:forEach var="product" items="${summary.topProducts()}"
                                                varStatus="status">
                                                <tr class="table-row">
                                                    <td class="table-cell text-gray-500">${status.index + 1}</td>
                                                    <td class="table-cell">
                                                        <div class="font-medium">${product.productName()}</div>
                                                        <div class="text-xs text-gray-500">${product.productCode()}
                                                        </div>
                                                    </td>
                                                    <td class="table-cell text-right">${product.totalQuantitySold()}
                                                    </td>
                                                    <td class="table-cell text-right font-medium">
                                                        Rs.
                                                        <fmt:formatNumber value="${product.totalRevenue()}"
                                                            pattern="#,##0.00" />
                                                    </td>
                                                </tr>
                                            </c:forEach>
