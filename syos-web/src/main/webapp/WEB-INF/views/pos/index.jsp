                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-900">
                                        Rs.
                                        <fmt:formatNumber value="${todaySales != null ? todaySales : 0}"
                                            pattern="#,##0.00" />
                                    </p>
                                </div>
                        ...
                        <div class="stat-card border-syos-success">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-900">${todayBillCount != null ?
                                        todayBillCount : 0}</p>
                                </div>
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                <c:forEach var="bill" items="${recentBills}">
                                                    <tr class="table-row">
                                                        <td class="table-cell">
                                                            <span
                                                                class="font-mono text-sm">${bill.serialNumberString}</span>
                                                        </td>
                                                        <td class="table-cell">
                                                            <span
                                                                class="badge ${bill.storeType == 'PHYSICAL' ? 'badge-info' : 'badge-success'}">
                                                                ${bill.storeType}
                                                            </span>
                                                        </td>
                                                        ...
                                                        <td class="table-cell text-right font-medium">
                                                            Rs.
                                                            <fmt:formatNumber value="${bill.totalAmount.amount}"
                                                                pattern="#,##0.00" />
                                                        </td>
