    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            <%@ taglib prefix="t" tagdir="/WEB-INF/tags" %>
                ...
                <t:layout pageTitle="Inventory Reports" activeNav="reports">
                    ...
                    <div class="card mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div class="p-4 bg-red-50 rounded-lg">
                                ...
                                <p class="text-red-600 mt-1">Products where store stock is below the configured minimum.
                                    Use this at end of day to know what needs restocking.</p>
                            </div>
                            <div class="p-4 bg-orange-50 rounded-lg">
                                <h4 class="font-medium text-orange-800">Reorder Level Report</h4>
                                <p class="text-orange-600 mt-1">Products where main inventory total is below 70 units.
                                    These need to be purchased from suppliers.</p>
                            </div>
                            <div class="p-4 bg-indigo-50 rounded-lg">
                                <h4 class="font-medium text-indigo-800">Batch Stock Report</h4>
                                <p class="text-indigo-600 mt-1">Complete view of all batches with quantities in main
                                    inventory, physical store, and online store.</p>
                            </div>
                        </div>
                    </div>
