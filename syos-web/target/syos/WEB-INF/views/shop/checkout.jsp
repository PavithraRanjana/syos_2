...
<body class="bg-gray-50 min-h-screen">
    ...
    <nav class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="${pageContext.request.contextPath}/cart" class="text-gray-600 hover:text-syos-primary flex items-center">
    ...
    <div class="bg-white border-b">
        <div class="max-w-3xl mx-auto px-4 py-4">
            <div class="flex items-center justify-center space-x-4">
                <div class="flex items-center">
                    <div class="h-8 w-8 bg-syos-success text-white rounded-full flex items-center justify-center">
                ...
                <div class="flex items-center">
                    <div class="h-8 w-8 bg-syos-primary text-white rounded-full flex items-center justify-center">2</div>
                    <span class="ml-2 text-sm font-medium text-gray-900">Checkout</span>
                </div>
                <div class="flex-1 h-0.5 bg-gray-200"></div>
                <div class="flex items-center">
                    <div class="h-8 w-8 bg-gray-200 text-gray-600 rounded-full flex items-center justify-center">3</div>
    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <textarea id="deliveryNotes" rows="3" placeholder="Any special instructions for delivery..."
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:border-syos-primary transition-colors">
                            ...
                            <label class="flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:border-syos-primary transition-colors opacity-50">
        ...
        <div id="successModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 p-8 text-center">
                <div class="h-16 w-16 bg-syos-success rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                    </svg>
                </div>
                <h3 class="text-2xl font-bold text-gray-900 mb-2">Order Placed!</h3>
                <p class="text-gray-600 mb-4">Thank you for your order. We'll send you an email confirmation shortly.</p>
                <p class="text-sm text-gray-500 mb-6">Order Number: <span id="orderNumber" class="font-semibold text-gray-900"></span></p>
                <div class="space-y-3">
                    <a href="${pageContext.request.contextPath}/orders" class="block w-full bg-syos-primary text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition-colors">
                        View My Orders
                    </a>
                    <a href="${pageContext.request.contextPath}/shop" class="block w-full border border-gray-300 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-50 transition-colors">
                        Continue Shopping
                    </a>
                </div>
            </div>
    ...
    <script>
        ...
        async function loadCheckoutData() {
            try {
                // Load cart and customer data in parallel
                const [cartResponse, customerResponse] = await Promise.all([
                    fetch(ctx + '/api/cart'),
                    fetch(ctx + '/api/auth/status')
                ]);
        ...
        async function placeOrder() {
            ...
            // Validate form
            const requiredFields = ['firstName', 'lastName', 'email', 'phone', 'streetAddress', 'city', 'postalCode'];
